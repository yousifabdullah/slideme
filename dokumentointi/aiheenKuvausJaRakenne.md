...
* Toteutetaan A*-algoritmi sekä BFS-algoritmi pelitilanteen ratkaisemiseen. Erilaisia vedoksia algoritmeista on mahdollista käyttää, minkä vuoksi erityistä tavoitetta aikavaativuudelle ei vielä ole, mutta tilavaativuuden kannalta on olennaisinta säilyttää 8-pelin peliruutujen järjestys taulukossa, joka tarvittaessa kopioidaan muistiin, siis O(n). Pääasiallinen lähde projektille, mutta erityisesti algoritmeille: https://www.cs.princeton.edu/courses/archive/fall12/cos226/assignments/8puzzle.html.
